...
int main()
{
    ...
    std::cout << "\nAfter these requests, there are " << holes.fragment_count() << " holes, and " << holes.leftovers() << "/128 KB un-used.(Any unit above 3 units)\n";
